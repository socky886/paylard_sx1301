...
tLoRaSettings LoRaSettings =
{
    ...
    1,                // ErrorCoding [1: 4/5, 2: 4/6, 3: 4/7, 4: 4/8]                                                                                                                    ,                // ErrorCoding [1: 4/5, 2: 4/6, 3: 4/7, 4: 4/8]
    ...
    100,              // TxPacketTimeout
    100,              // RxPacketTimeout
    32,              // PayloadLength (used for implicit header mode)
};
...
//
    ...
    tx_vSpiWrite(REG_LR_OPMODE, 0x80);
//
    tx_ReadBuffer( REG_LR_OPMODE, 0x69, SX1276Regs + 1 );
    SX1276LR.RegLna = RFLR_LNA_GAIN_G1;
    tx_WriteBuffer( REG_LR_OPMODE, 0x69, SX1276Regs + 1  );
...
void SX1276LoRaSetDefaults( void )
{
    ...
    SX1276LR.RegVersion  = tx_bSpiRead( REG_LR_VERSION );
}
...
void SX1276LoRaSetOpMode( uint8_t opMode )
{
    ...
    tx_vSpiWrite( REG_LR_OPMODE, SX1276LR.RegOpMode );
}

uint8_t SX1276LoRaGetOpMode( void )
{
    SX1276LR.RegOpMode =  tx_bSpiRead( REG_LR_OPMODE);
...
{
    SX1276LR.RegLna = tx_bSpiRead( REG_LR_LNA );
...
double SX1276LoRaReadRssi( void )
{
    ...
    SX1276LR.RegRssiValue = tx_bSpiRead( REG_LR_RSSIVALUE );
...
uint32_t SX1276LoRaProcess( void )
{
    ...
    case RFLR_STATE_RX_INIT:
        ...
        tx_WriteBuffer( REG_LR_DIOMAPPING1, &SX1276LR.RegDioMapping1, 2 );
